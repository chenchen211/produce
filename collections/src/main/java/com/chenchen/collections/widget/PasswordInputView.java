...
public class PasswordInputView extends AppCompatEditText {
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        Log.i(TAG, "PasswordInputView: "+borderWidth+"=="+borderRadius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 内容区
        contentRectF.set(borderRectF.left + defaultContMargin, borderRectF.top + defaultContMargin,
                borderRectF.right - defaultContMargin, borderRectF.bottom - defaultContMargin);

        borderPaint.setColor(Color.WHITE);
        canvas.drawRoundRect(contentRectF, borderRadius, borderRadius, borderPaint);
