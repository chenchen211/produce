...
//    private boolean mCanLeftSlide2 = false;
    ...
    public ResideLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray tp = context.obtainStyledAttributes(attrs, R.styleable.ResideLayout, defStyle, 0);
        int overhangSize = tp.getDimensionPixelSize(R.styleable.ResideLayout_overhangSize, 150);
        tp.recycle();
        mOverhangSize = (int) (overhangSize + 0.5f);
